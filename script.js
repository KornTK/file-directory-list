...
window.onload = ()=>{
    function ajax(){
        ...
        xhr.onload = ()=>{ //once ajax loaded
            ...
            if(xhr.status == 200 && xhr.status < 300){
                ...
                title.innerText = "เชื่อมต่อกับเซิฟเวอร์สําเร็จ!";
                subTitle.innerText = "เชื่อมต่อกับเซิฟเวอร์สําเร็จ!";
    ...
    function offline(){ //function for offline
        ...
        title.innerText = "คุณขาดการเชื่อมต่อกับเซิร์ฟเวอร์!";
        subTitle.innerText = "คุณขาดการเชื่อมต่อกับเซิร์ฟเวอร์!";
